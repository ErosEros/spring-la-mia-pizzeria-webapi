...
import com.corsojava.pizzeria.repo.IngredientRepository;
...
public class IngredientController {
	...
	public String index(			
			Model model) {	
		List<Ingredient> res = ingredientrep.findAll(Sort.by("name"));	//tutti gli ingredienti ordinati per nome
	...
	@PostMapping("/create")  	//gestirà le richieste di tipo POST di tipo /pizza/create
	public String store(
